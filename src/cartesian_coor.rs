...
use crate::{interpolator, bathymetry_data::BathymetryData};
...
#[cfg(test)]
/// Tests for the cartesian_coor module
mod test_cartestian_coor {

    use super::{CartesianFile, BathymetryData};
    use std::path::Path;
